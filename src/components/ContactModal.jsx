...
function ContactModal({ text, setContactModal , type }) {
  ...
  return (
    <div className="modal">
      <div className="card">
        ...
        <p className="message" style={{lineHeight:"1.5rem"}}>
        ...
        }
        {
            ...
            <ul className="example-2" style={{paddingLeft:'0'}}>
          <li className="icon-content">
            <a
              href={"https://linkedin.com/" + uri.linkedin}
              aria-label="LinkedIn"
          ...
          <li className="icon-content">
            <a
              href={"https://www.github.com/" + uri.github}
              aria-label="GitHub"
              data-social="github">
              <div className="filled"></div>
              <svg
          ...
          <li className="icon-content">
            <a
              href={"https://www.instagram.com/" + uri.instagram}
          ...
          <li className="icon-content">
            <a
              href={"https://twitter.com/" + uri.twitter}
              aria-label="Youtube"
              data-social="youtube">
              <div className="filled"></div>
              {/* <svg
      ...
      >
        ...
        <div className="actions">
            <a className="mark-as-read_invert" onClick={()=>{setContactModal(false)}}>
              Close
            </a>
        </div>
      </div>
